		...
		<?php if (bbp_is_reply_edit()) : ?>
				...
				<div id="new-reply-<?php bbp_topic_id(); ?>" class="bbp-reply-form">
					<form id="new-post" name="new-post" method="post">
						...
						<fieldset class="bbp-form">
							<legend><?php printf(esc_html__('Reply To: %s', 'bdthemes-element-pack'), (bbp_get_form_reply_to()) ? sprintf(esc_html__('Reply #%1$s in %2$s', 'bdthemes-element-pack'), esc_html(bbp_get_form_reply_to()), esc_html(bbp_get_topic_title())) : esc_html(bbp_get_topic_title())); ?></legend>
								...
								<?php if (bbp_is_reply_edit()) : ?>
									...
									<?php if (bbp_allow_revisions()) : ?>
										...
										<fieldset class="bbp-form">
											...
											<div>
												<label class="bdt-inline-block" for="bbp_reply_edit_reason"><?php printf(esc_html__('Optional reason for editing:', 'bdthemes-element-pack'), esc_html(bbp_get_current_user_name())); ?></label><br />
			...
			<?php elseif (bbp_is_topic_closed()) : ?>
				...
				<div id="no-reply-<?php bbp_topic_id(); ?>" class="bbp-no-reply">
					<div class="bbp-template-notice">
						<ul>
							<li><?php printf(esc_html__('The topic &#8216;%s&#8217; is closed to new replies.', 'bdthemes-element-pack'), esc_html(bbp_get_topic_title())); ?></li>
						</ul>
					</div>
				</div>
			...
			<?php elseif (bbp_is_forum_closed(bbp_get_topic_forum_id())) : ?>
				...
				<div id="no-reply-<?php bbp_topic_id(); ?>" class="bbp-no-reply">
					<div class="bbp-template-notice">
						<ul>
							<li><?php printf(esc_html__('The forum &#8216;%s&#8217; is closed to new topics and replies.', 'bdthemes-element-pack'), esc_html(bbp_get_forum_title(bbp_get_topic_forum_id()))); ?></li>
						</ul>
					</div>
				</div>
