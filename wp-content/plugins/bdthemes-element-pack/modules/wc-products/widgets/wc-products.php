...
class WC_Products extends Module_Base {
	...
	protected function register_controls() {
		...
		$this->start_controls_tab(
			'wc_products_image_style_normal',
			[
				'label' => esc_html__('Normal', 'bdthemes-element-pack'),
			]
		);
		...
		$this->add_group_control(
			...
			[ 
				'name'     => 'wc_products_image_background',
				'label'    => esc_html__( 'Image Background', 'bdthemes-element-pack' ),
		...
		$this->add_responsive_control(
			'wc_products_image_container_border_radius',
			[ 
				'label'      => esc_html__( 'Container Border Radius', 'bdthemes-element-pack' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'rem', '%' ],
				'selectors'  => [ 
		...
		$this->add_responsive_control(
			'wc_products_image_padding',
			[
				'label'      => esc_html__( 'Padding', 'bdthemes-element-pack' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'rem', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .bdt-wc-products .bdt-wc-product-image' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			Group_Control_Background::get_type(),
			[ 
				'name'     => 'wc_products_image_hover_background',
				'label'    => esc_html__( 'Image Background', 'bdthemes-element-pack' ),
				'selector' => '{{WRAPPER}} .bdt-wc-products .bdt-wc-product-inner:hover .bdt-wc-product-image',
			]
		);

		$this->add_control(
			'wc_products_image_hover_border_color',
			[
				'label' => esc_html__('Border Color', 'bdthemes-element-pack'),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-wc-products .bdt-wc-product-inner:hover .bdt-wc-product-image' => 'border-color: {{VALUE}};',
				],
				'condition' => [
		...
		$this->add_group_control(
			Group_Control_Box_Shadow::get_type(),
			[ 
				'name'     => 'wc_products_image_hover_shadow',
				'exclude'  => [ 
					'shadow_position',
				],
				'selector' => '{{WRAPPER}} .bdt-wc-products .bdt-wc-product-inner:hover .bdt-wc-product-image',
		...
		$this->add_group_control(
			Group_Control_Background::get_type(),
			[
				'name' => 'wc_products_button_gradient',
				'label' => esc_html__('Background', 'bdthemes-element-pack'),
				'types' => ['gradient'],
				'selector' => '{{WRAPPER}} .bdt-wc-products .bdt-wc-add-to-cart a',
				'fields_options' => [
					'background' => [
						'label' => esc_html__('Background Gradient', 'bdthemes-element-pack'),
					],
				],
			]
		);
		...
		$this->add_group_control(
			Group_Control_Background::get_type(),
			[
				'name' => 'wc_products_button_hover_gradient',
				'label' => esc_html__('Background', 'bdthemes-element-pack'),
				'types' => ['gradient'],
				'selector' => '{{WRAPPER}} .bdt-wc-products .bdt-wc-add-to-cart a:hover',
				'fields_options' => [
					'background' => [
						'label' => esc_html__('Background Gradient', 'bdthemes-element-pack'),
					],
