			...
			<?php if (bbp_current_user_can_access_create_reply_form()) : ?>
				...
				<div id="new-reply-<?php bbp_topic_id(); ?>" class="bbp-reply-form">
					...
					<form id="new-post" name="new-post" method="post">
						...
						<fieldset class="bbp-form">
							<legend>
								<?php printf(esc_html__('Reply To: %s', 'bdthemes-element-pack'), (bbp_get_form_reply_to()) ?
								sprintf(esc_html__('Reply #%1$s in %2$s', 'bdthemes-element-pack'), esc_html(bbp_get_form_reply_to()), esc_html(bbp_get_topic_title())) : esc_html(bbp_get_topic_title())); ?>
							</legend>
									...
									<?php if (bbp_allow_revisions()) : ?>
										...
										<fieldset class="bbp-form">
											...
											<div>
												...
												<label for="bbp_reply_edit_reason"><?php printf(esc_html__('Optional reason for editing:', 'bdthemes-element-pack'), esc_html(bbp_get_current_user_name())); ?></label><br />
