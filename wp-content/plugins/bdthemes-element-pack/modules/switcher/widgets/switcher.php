			...
			<div class="bdt-switcher-item-content-inner">
				<div>
					...
					if ('custom' == $settings['source_a'] and !empty($settings['switch_a_content'])) {
						...
						echo Element_Pack_Loader::elementor()->frontend->get_builder_content_for_display($settings['template_id_a']); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
						echo wp_kses( element_pack_template_edit_link($settings['template_id_a']), element_pack_allow_tags( 'text' ) );
					} elseif ('anywhere' == $settings['source_a'] and !empty($settings['anywhere_id_a'])) {
						// PHPCS - should not be escaped.
						echo Element_Pack_Loader::elementor()->frontend->get_builder_content_for_display($settings['anywhere_id_a']); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
						echo wp_kses( element_pack_template_edit_link($settings['anywhere_id_a']), element_pack_allow_tags( 'text' ) );
			...
			<div class="bdt-switcher-item-content-inner">
				<div>
					...
					if ('custom' == $settings['source_b'] and !empty($settings['switch_b_content'])) {
						...
						// PHPCS - should not be escaped.
						echo Element_Pack_Loader::elementor()->frontend->get_builder_content_for_display($settings['template_id_b']); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
						echo wp_kses( element_pack_template_edit_link($settings['template_id_b']), element_pack_allow_tags( 'text' ) );
					} elseif ('anywhere' == $settings['source_b'] and !empty($settings['anywhere_id_b'])) {
						// PHPCS - should not be escaped.
						echo Element_Pack_Loader::elementor()->frontend->get_builder_content_for_display($settings['anywhere_id_b']); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
						echo wp_kses( element_pack_template_edit_link($settings['anywhere_id_b']), element_pack_allow_tags( 'text' ) );
