	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}}:hover .bdt-ep-advanced-icon-box .bdt-ep-advanced-icon-box-title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}}:hover .bdt-ep-advanced-icon-box .bdt-ep-advanced-icon-box-title',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}}:hover .bdt-ep-advanced-icon-box .bdt-ep-advanced-icon-box-sub-title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}}:hover .bdt-ep-advanced-icon-box .bdt-ep-advanced-icon-box-sub-title',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}}:hover .bdt-ep-advanced-icon-box .bdt-ep-advanced-icon-box-description' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}}:hover .bdt-ep-advanced-icon-box .bdt-ep-advanced-icon-box-description',
			]
		);
			...
			<div class="bdt-ep-advanced-icon-box-content">
				...
				<?php if ($settings['description_text']) : ?>
					<div <?php $this->print_render_attribute_string('description_text'); ?>>
						...
						echo $this->parse_text_editor($settings['description_text']);
						?>
					</div>
				<?php endif; ?>
