		...
		if (!bbp_is_single_forum()) : ?>
						...
						<fieldset class="bbp-form">
							<legend>
								...
								if (bbp_is_topic_edit()) :
									printf(esc_html__('Now Editing &ldquo;%s&rdquo;', 'bdthemes-element-pack'), esc_html(bbp_get_topic_title()));
								else : (bbp_is_single_forum() && bbp_get_forum_title())
										? printf(esc_html__('Create New Topic in &ldquo;%s&rdquo;', 'bdthemes-element-pack'), esc_html(bbp_get_forum_title()))
							...
							<div>
								...
								<?php
								// Check if bbPress is active and get title max length
								$max_length = function_exists( 'bbp_get_title_max_length' ) ? absint( bbp_get_title_max_length() ) : 80;
								?>

								<p>
									<label for="bbp_topic_title"><?php printf(esc_html__('Topic Title (Maximum Length: %d):', 'bdthemes-element-pack'), esc_html($max_length)); ?></label><br />
									<input type="text" id="bbp_topic_title" value="<?php bbp_form_topic_title(); ?>" size="40" name="bbp_topic_title" maxlength="<?php echo esc_attr( $max_length ); ?>" />
								</p>
								...
								<?php if (bbp_allow_revisions() && bbp_is_topic_edit()) : ?>
									...
									<fieldset class="bbp-form">
										...
										<div>
											<label for="bbp_topic_edit_reason"><?php printf(esc_html__('Optional reason for editing:', 'bdthemes-element-pack'), esc_html(bbp_get_current_user_name())); ?></label><br />
			...
			<?php elseif (bbp_is_forum_closed()) : ?>
				...
				<div id="forum-closed-<?php bbp_forum_id(); ?>" class="bbp-forum-closed">
					<div class="bbp-template-notice">
						<ul>
							<li><?php printf(esc_html__('The forum &#8216;%s&#8217; is closed to new topics and replies.', 'bdthemes-element-pack'), esc_html(bbp_get_forum_title())); ?></li>
						</ul>
					</div>
				</div>
