...
class Advanced_Gmap extends Module_Base
{
    ...
    public function render()
    {
        ...
        foreach ($settings['marker'] as $marker_item) {
            ...
            $marker_settings['content'] = isset($marker_item['marker_content']) ? nl2br( wp_kses( $marker_item['marker_content'], element_pack_allow_tags('safe_formatting') ) ) : '';
...
foreach ($settings['marker'] as $marker_item) {
            ...
            $this->add_render_attribute('bdt-gmap-list-item', 'data-settings', [
                wp_json_encode(array_filter([
                    ...
                    'image' => $image_src,
                    'content' => isset($marker_item['marker_content']) ? nl2br( wp_kses( $marker_item['marker_content'], element_pack_allow_tags('safe_formatting') ) ) : '',
