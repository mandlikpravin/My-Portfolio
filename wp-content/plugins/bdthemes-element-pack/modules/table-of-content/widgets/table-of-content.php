...
class Table_Of_Content extends Module_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'hash_navigation',
			[
				'label' => esc_html__('Hash Location', 'bdthemes-element-pack') . BDTEP_NC,
				'type'  => Controls_Manager::SWITCHER,
				'description'       => esc_html__('Enable navigation to sections when visiting URLs with hash fragments (e.g., #section-name).', 'bdthemes-element-pack'),
				'condition' => [
					'history' => 'yes',
				],
			]
		...
		$this->add_control(
			'extend_page',
			[
				'label' => esc_html__('Extend Page', 'bdthemes-element-pack'),
				'type'  => Controls_Manager::SWITCHER,
				//'default'  => 'yes',
				...
				'table-of-content' => [
					'data-settings' => [
						wp_json_encode([
							...
							'hashNavigation' => $settings['hash_navigation'] ? true : false,
