...
class Flip_Box extends Base {
    ...
    protected function __font_side_content_controls() {
		...
		$this->add_control(
			'front_text_vertical_align',
			[
				'label' => esc_html__( 'Vertical Position', 'happy-addons-pro' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'top' => [
				...
				'selectors' => [
					'{{WRAPPER}} .ha-flip-box-front' => 'align-items: {{VALUE}}',
				],
			]
		);
    ...
    protected function __back_side_content_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .ha-flip-box-back' => 'align-items: {{VALUE}}',
				],
			]
		);
    ...
    protected function __font_side_style_controls() {
		...
		$this->add_control(
			'front_background_overlay_type',
			[
				'label' => __( 'Background Overlay Type', 'happy-addons-pro' ),
				'type' => Controls_Manager::SELECT,
				'separator' => 'before',
				'options' => [
					'normal' => 'Normal',
        ...
        $this->add_control(
            ...
            [
                ...
                'condition' => [
                    'front_background_image_background' => 'classic',
                    'front_background_overlay_type!' => 'advanced',
                ],
                'selectors' => [
        ...
        $this->add_group_control(
            Group_Control_Background::get_type(),
            [
                'name' => 'front_background_overlay_advanced',
                'types' => [ 'classic', 'gradient' ],
				'exclude' => [ 'image' ], // remove image bg option
                'selector' => '{{WRAPPER}} .ha-flip-box-front:before',
                'condition' => [
                    'front_background_image_background' => 'classic',
                    'front_background_overlay_type' => 'advanced',
                ],
        ...
        // $this->add_control(
        //     'front_background_overlay_b',
        //     [
        //         'label' => __( 'Second Color', 'happy-addons-pro' ),
        //         'type' => Controls_Manager::COLOR,
        //         'condition' => [
        //             'front_background_image_background' => 'classic',
        //             'front_background_overlay_type' => 'gradient',
        //         ],
        //         'selectors' => [
        //             // '{{WRAPPER}} .ha-flip-box-front:before' => 'background-color: {{VALUE}}',
        //             '{{WRAPPER}} .ha-flip-box-front:before' => 'background: linear-gradient(180deg, {{front_background_overlay.VALUE}} 5%, {{VALUE}} 100%)',
        //         ],
        //     ]
        // );
    ...
    protected function __back_side_style_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'condition' => [
                    'back_background_image_background' => 'classic',
                    'back_background_overlay_type!' => 'advanced'
                ],
                'selectors' => [
        ...
        $this->add_group_control(
            Group_Control_Background::get_type(),
            [
                'name' => 'back_background_overlay_advanced',
                'types' => [ 'classic', 'gradient' ],
				'exclude' => [ 'image' ], // remove image bg option
                'selector' => '{{WRAPPER}} .ha-flip-box-back:before',
                'condition' => [
                    'back_background_image_background' => 'classic',
                    'back_background_overlay_type' => 'advanced',
                ],
